...
$(document).ready(function () {
    ...
    var __archIsMobile = !!window.__archMobile;
    ...
    var swiper = new Swiper(".tc-testimonials-style1 .marq-slider", {
        ...
        centeredSlides: true,
        slidesPerView: "auto",
        speed: __archIsMobile ? 20000 : 10000,
        autoplay: __archIsMobile ? false : { delay: 1 },
        loop: !__archIsMobile,
        allowTouchMove: !__archIsMobile,
...
// ------------ gsap scripts -----------
$(function () {
    if (window.__archMobile) return;
    if (window.__archGsapInited) return;
    if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined' || typeof ScrollSmoother === 'undefined' || typeof SplitText === 'undefined') return;
    window.__archGsapInited = true;
